    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post" action="">
                ...
                <div class="form-group already"><button class="btn btn-primary btn-block" type="submit" name="register">Sign Up</button></div> <span class="text-sm">You already have an account?</span> <a href="#"class="text-sm hover:text-blue-400">Login here.</a></form>
        </div>
    </div>
