    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post" action="">
                ...
                <div class="form-group already"><button class="btn btn-primary btn-block" type="submit" name="login">Sign In</button></div> <span class="text-sm">Dont have a account?</span> <a href="register.php"class="text-sm hover:text-blue-400">Sign Up here.</a></form>
        </div>
    </div>
